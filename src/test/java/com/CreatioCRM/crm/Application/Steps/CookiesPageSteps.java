...
import com.CreatioCRM.crm.Application.Elements.CookiesPageElements;
...
//		Assert.assertTrue(isElementDisplayed(necessarySwitchtn));
		Assert.assertTrue(!isElementEnabled(necessaryCookiesbtn));
